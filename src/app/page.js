    ...
    <div className="min-h-screen">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        {/* <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute top-96 right-1/3 text-6xl animate-pulse animation-delay-1000">🌾</div>
          <div className="absolute top-1/2 left-20 text-8xl animate-pulse animation-delay-3000">🌱</div>
